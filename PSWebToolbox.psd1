#
# Module manifest for module 'PSWebToolbox'
#
...
@{
    ...
    Description = 'PowerShell Module providing a simple way to gather cleaned RSS feeds from websites. It''s easy to use.'
